interface Blend {
	...
	*/
	track: 
		(animation: Animation, options: 
			Partial<{
				...
				alpha: number,
				priority: number,
				startFade: number, stopFade: number
	 ...
	 */
	crossfade: 
		(fromAnim: Animation, toAnim: Animation, duration: number, priority?: number) 
	 ...
	 */
	blend: 
		(animA: Animation, animB: Animation, weight: number, priority?: number)
	 ...
	 */
	snap:
		(anim: Animation, priority?: number)
	 ...
	 */
	additive: 
		(anim: Animation, weight: number, priority?: number)
